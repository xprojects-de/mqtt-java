...
public class TestFrame extends javax.swing.JFrame implements Runnable {
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(29, 29, 29)
                                    .addComponent(jTextFieldTopic, javax.swing.GroupLayout.PREFERRED_SIZE, 259, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
  ...
  private void jButtonSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSendActionPerformed
    try {
      sendMessage(jTextFieldTopic.getText(), jTextFieldMessage.getText());
    } catch (Exception ex) {
      ex.printStackTrace();
    }
  ...
  private void jButtonTopicSubscribeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTopicSubscribeActionPerformed
    mqttClient.subscribe(jTextFieldTopic.getText(), this.ml);
      ...
      public void run() {
        try {
          ...
          for (int k = 0; k < loops; k++) {
            sendMessageLoop(topic, ("Looptest " + k), (k + 1));
            if (delay > 0) {
              Thread.sleep(delay);
            }
          }
